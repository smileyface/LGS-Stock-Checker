...
class Game_Kastle_Santa_Clara(Store):
    def __init__(self):
        super().__init__(
            name="Game Kastle (Santa Clara)",
            slug="game_kastle_santa_clara",
            homepage="https://gamekastle.co/",
            search_url="https://gamekastle.co/products/search",
    ...
    def _parse_variants(self, product: BeautifulSoup) -> List[Dict[str, Any]]:
        ...
        variants = []
        # This theme has duplicate variant sections for grid/list/detail views.
        # We target the one inside the 'meta' div to avoid parsing the same data multiple times.
