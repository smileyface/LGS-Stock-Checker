...
@patch("managers.flask_manager.server_listener.database.add_card_names_to_catalog")
...
@patch("managers.flask_manager.server_listener.database.add_set_data_to_catalog")
...
@patch("managers.flask_manager.server_listener.database.bulk_add_finishes")
...
@patch("managers.flask_manager.server_listener.database.bulk_add_printing_finish_associations")
@patch("managers.flask_manager.server_listener.database.get_all_finishes_map")
@patch("managers.flask_manager.server_listener.database.get_chunk_printing_ids")
@patch("managers.flask_manager.server_listener.database.bulk_add_card_printings")
...
def test_integration_handle_catalog_card_names_result(db_session):
    ...
    # Assert
    cards = db_session.query(Card).filter(Card.name.in_(payload["names"])).all()
    assert len(cards) == 2
